...
@section('content')
                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p>Surveyor Outstanding Report.</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                            ...
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col">
                                                    <div class="user-card">
                                                        ...
                                                        @endif
                                                        <div class="user-info">
                                                            <span class="tb-lead">{{ $data->surveyor_name }} <span class="dot dot-warning d-md-none ml-1"></span></span>
                                                            <span>{{ $data->surveyor_email }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                    <div class="user-card">
                                                        <div class="user-info">
                                                            ...
                                                            <span>{{ $data->department_name }} Dept.</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="nk-tb-col tb-col-mb">
                                                    <span class="text-dark">{{ $data->total_data }}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
    ...
    data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        ...
        <div class="nk-block">
            <form action="{{ url('outstanding-report-result') }}" method="POST">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-group">
