...
@section('content')
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Jenis Agunana</span></th>
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Tanggal Visit</span></th>
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="search-modal" data-toggle-screen="any"
        ...
        <div class="nk-block">
            <form action="{{ url('download-data-fix-xlsx') }}" method="POST">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="">Mode</label>
                            <div class="form-control-wrap">
