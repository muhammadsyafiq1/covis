...
@section('content')
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title mb-0">Client Setting</h4>
                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    ...
                                                    @else
                                                    <li class="nk-block-tools-opt"><a href="#" class="toggle btn btn-primary" data-target="add-modal"><em class="icon ni ni-plus"></em><span>Add Client</span></a></li>
                                                    @endif
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Website</span></th>
                                            ...
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                    <ul class="list-status">
                                                        <li><em class="icon text-primary ni ni-call"></em> <a href="tel:{{ $data->phone }}"><span>Call</span></a></li>
                                                    </ul>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                    <ul class="list-status">
                                                        <li><em class="icon text-primary ni ni-globe"></em> <a href="{{ $data->website }}" target="_blank"><span>Links</span></a></li>
                                                    </ul>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                @if ($data->is_active == 1)
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    ...
                                                    @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('project-edit', encrypt($data->id)) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <em class="icon ni ni-edit"></em>
                                                            </a>
                                                        </li>
                                                        @if ($data->is_active == 0)
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('client-active', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('client-inactive', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="add-modal" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        ...
        <div class="nk-block">
            <form action="{{route('setting-project-store')}}" method="POST">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="name">Client Name <span class="text-danger ml-1">*</span></label>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="phone">Phone <span class="text-danger ml-1">*</span></label>
                            <div class="form-control-wrap">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="website">Website <span class="text-danger ml-1">*</span></label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="website" name="website" value="https://" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
