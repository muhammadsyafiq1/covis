...
@section('content')
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title mb-0">Priority Setting</h4>
                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li class="nk-block-tools-opt"><a href="#" class="toggle btn btn-primary" data-target="add-modal"><em class="icon ni ni-plus"></em><span>Add Priority</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('priority-edit', encrypt($data->id))}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <em class="icon ni ni-edit"></em>
                                                            </a>
                                                        </li>
                                                        @if ($data->is_active == 0)
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{route('priority-active', encrypt($data->id))}}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @else
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{route('priority-inactive', encrypt($data->id))}}" class="btn btn-trigger btn-icon"
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="add-modal" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">New Priority</h5>
                <div class="nk-block-des">
