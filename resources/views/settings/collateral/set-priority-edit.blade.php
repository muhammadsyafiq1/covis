                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title mb-0">Edit Collateral Priority</h3>
                                <div class="nk-block-des text-soft">
                                    <p>{{$data->name}}.</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ route('setting-covis-priority') }}"
                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    ...
                                    <form action="{{route('priority-update', encrypt($data->id)) }}" method="POST">
                                    @csrf
                                        <div class="row g-3">
                                            <div class="col-6">
