...
@section('content')
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title mb-0">Classification Setting</h4>
                                        <div class="nk-block-des">
                                            <p>You have total {{ $view->count() }} data.</p>
                                        </div>
                                    </div>
                                    <div class="nk-block-head-content">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li class="nk-block-tools-opt"><a href="#"
                                                            class="toggle btn btn-primary" data-target="add-modal"><em
                                                                class="icon ni ni-plus"></em><span>Add Classes</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        @foreach ($view as $data)
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                    <span
                                                        class="">{{ !$data->note ? 'N/A' : $data->note }}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                    @if ($data->is_active == 1)
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('classes-edit', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @if ($data->is_active == 0)
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{route('classes-active', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @else
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{route('classes-inactive', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="add-modal" data-toggle-screen="any"
        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">New Classification</h5>
                <div class="nk-block-des">
        ...
        <div class="nk-block">
            <form action="{{route('collateral-classes-store')}}" method="POST">
                @csrf
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary" type="submit"><em class="icon ni ni-plus"></em><span>Add
                                New</span></button>
                    </div>
                </div>
            </form>
