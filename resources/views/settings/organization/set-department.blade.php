...
@section('content')
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title mb-0">Department Setting</h4>
                                    ...
                                    <div class="nk-block-head-content">
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                ...
                                                @else
                                                    <li class="nk-block-tools-opt"><a href="#" class="toggle btn btn-primary" data-target="add-modal"><em class="icon ni ni-plus"></em><span>Add Department</span></a>
                                                    </li>
                                                @endif
                                                </ul>
                                            </div>
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Total
                                                        Users</span></th>
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Note /
                                                        Description</span></th>
                                        ...
                                        @foreach ($view as $data)
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col">
                                                    <div class="user-card">
                                                        <div class="user-avatar xs bg-dim-primary d-none d-sm-flex text-uppercase">
                                                            <span>{{ $data->code }}</span>
                                                        </div>
                                                        <div class="user-info">
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                    <span class="">{{ $data->user->count() }}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    ...
                                                    @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('department-edit', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @if ($data->is_active == 0)
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('department-active', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('department-inactive', encrypt($data->id)) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Inactive">
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="add-modal" data-toggle-screen="any"
        ...
        <div class="nk-block">
            <form action="{{route('setting-department-store')}}" method="POST">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
