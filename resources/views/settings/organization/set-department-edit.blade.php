                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title mb-0">Edit Department</h3>
                                <div class="nk-block-des text-soft">
                                    <p>{{ $data->name }}.</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ route('setting-department') }}"
                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    ...
                                    <form action="{{route('department-update', encrypt($data->id)) }}" method="POST">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="name">Department Name <code
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input readonly value="{{old('code') ? old('code') : $data->code}}" type="text" class="form-control text-uppercase @error('code') is-invalid @enderror " id="code" name="code" required>
                                                    </div>
                                                    @error('code')
