...
@section('content')
                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title mb-0">Job Position Setting</h4>
                                    ...
                                    <div class="nk-block-head-content">
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                ...
                                                @else
                                                    <li class="nk-block-tools-opt"><a href="#" class="toggle btn btn-primary" data-target="add-modal"><em class="icon ni ni-plus"></em><span>Add Job Position</span></a></li>
                                                @endif
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false" id="table_edit">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Total User</span></th>
                                        ...
                                        @foreach ($view as $data)
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                    <span class="">{{ $data->department->name }}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                    <span class="">{{ $data->userJobPosition->count() }}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    ...
                                                    @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('job-position-edit', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @if ($data->is_active == 0)
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('job-position-active', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
                                                        ...
                                                        @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('job-position-inactive', encrypt($data->id)) }}" class="btn btn-trigger btn-icon"
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="add-modal" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">New Job Position</h5>
                <div class="nk-block-des">
        ...
        <div class="nk-block">
            <form action="{{route('setting-job-position-store')}}" method="POST">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="department">Job Position Name <span class="text-danger ml-1">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="kode-upper form-control" id="code" name="code" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="department_id">Department <span class="text-danger ml-1">*</span></label>
                            <div class="form-control-wrap">
...
@push('addon-script')
    <script>
        $('#table_edit').on('click','.button-edit', function(){
            let id = $(this).data('id');
