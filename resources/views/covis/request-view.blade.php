                            ...
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <ul class="list-inline">
                                        <li>Customer Code: <span
                                                class="text-base">{{ $transaction->customer->code }}</span></li>
                                        <li>Client: <span
                                                class="text-base">{{ $transaction->customer->project->name }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card card-bordered">
                            <div class="card-aside-wrap">
                                            ...
                                            <div class="tab-pane active" id="tabItem1">
                                                    ...
                                                    <div class="profile-ud-list">
                                                        <div class="profile-ud-item">
                                                            <div class="profile-ud wider">
                                                                ...
                                                                <span
                                                                    class="profile-ud-value">{{ $transaction->customer->address }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="profile-ud-item">
                                                            <div class="profile-ud wider">
                                                ...
                                                <div class="nk-block">
                                                    <div class="nk-block-head nk-block-head-sm nk-block-between trigger-div">
                                                        ...
                                                        <a 
                                                            href="#" 
                                                            data-id="{{$transaction->customer->id}}"
                                ...
                                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="note-modal"
                                    ...
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h5 class="nk-block-title">New Admin Note</h5>
                                        </div>
                                    </div>
                                    <div class="nk-block">
                                        <form action="{{ route('update-note-customer') }}" method="POST">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <textarea class="form-control" id="admin_note" name="note" rows="10" required></textarea>
                                                            <input type="text" value="{{$customerTransaction->id}}" name="idTransaction">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#district_code").append(
                            `<option disabled selected>--- Select ---</option>`);
                        $.each(data, function(code, name) {
                            $("#district_code").append(new Option(code, name));
                        })
                    }
                })
            })
