                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title mb-0">Import New Order</h3>
                                <div class="nk-block-des text-soft">
                                    <p>Import your new order here.</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                    <div class="preview-block">
                                        <div class="row gy-4">
                                            <div class="col-sm-6">
                                                <form action="{{ route('import-order-excel') }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">File Size Limit (3MB) | </label>
                                                        <small><a href="{{ asset('images/template/order-import.xlsx') }}">Download Template</a></small>
